...
# Import routers
from app.api.v1 import auth, roles, audit, platform, users, jira, otp, projects, redis_chat, backlog, notifications, backlog_priority, meetings, ai, transcripts
...
app.include_router(ai.router, prefix=f"{settings.API_PREFIX}/ai", tags=["AI Services"])
